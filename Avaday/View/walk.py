from Avaday.globals import np, number_of_paths, ROOT_DIR
from Avaday.View.parameters import board_size, length_of_random_walk, number_of_random_walks
from Avaday.View.jump import draw_jump
